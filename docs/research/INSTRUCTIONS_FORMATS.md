...
À noter : LEGO détient des **brevets sur la génération automatique d'instructions** ([US8374829](https://image-ppubs.uspto.gov/dirsearch-public/print/downloadPdf/8374829) « Automatic generation of building instructions for building element models », [US9821242](https://image-ppubs.uspto.gov/dirsearch-public/print/downloadPdf/9821242), et [US11393153](https://image-ppubs.uspto.gov/dirsearch-public/print/downloadPdf/11393153) sur l'occlusion en instructions AR) — signe que le problème « décomposer un modèle en étapes » est traité industriellement comme un problème algorithmique, pas seulement éditorial.
