...
| **CH-2** Entraînement | 🟡 **It.1+2 faites** | mAP@50 test 0.679 → 0.773, rappel max 0.985 (le modèle voit quasi tout) ; prochain levier : scènes synthétiques réalistes multi-pièces |
